...
class RecentChat {
    ...
    var dictionary:NSDictionary{
        ...
        ], forKeys: [kOBJECTID as NSCopying,kCHATROOMID as NSCopying,kSENDERID as NSCopying,kSENDERNAME as NSCopying,kRECEIVERID as NSCopying,kRECEIVERNAME as NSCopying,kDATE as NSCopying,kMEMBERIDS as NSCopying,kLASTMESSAGE as NSCopying,kUNREADCOUNTER as NSCopying,kAVATARLINK as NSCopying
        ])
    }
    ...
    func saveToFirestore(){
        FirebaseReference(.Chats).document(self.objectId).setData(self.dictionary as! [String:Any])
    }
    func deletRecent(){
        FirebaseReference(.Chats).document(self.objectId).delete()
    }
}
